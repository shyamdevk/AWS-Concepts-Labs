...
---
# 🐳 **AWS ECS**
 ![Screenshot](https://github.com/shyamdevk/AWS-Concepts-Labs/blob/images/ecs1.png)
...
# 🟦 **2. What is AWS ECS (Elastic Container Service)?**
 ![Screenshot](https://github.com/shyamdevk/AWS-Concepts-Labs/blob/images/ecs.png)
